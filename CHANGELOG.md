...
- Authenticated wishlist routes: list, add, remove and check items.
- `WLF` Master Data entity with one idempotent document per shopper and SKU.
- Catalog validation that the SKU exists and belongs to the product.
